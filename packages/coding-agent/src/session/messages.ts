...
/** Invalidate append-only conversion shortcuts after an owner rewrites an array's existing prefix. */
export function invalidateMessageArrayCache(messages: AgentMessage[]): void {
