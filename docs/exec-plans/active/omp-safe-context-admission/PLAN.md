...
The session routes that deliberate refusal directly to retry settlement without restarting maintenance or fallback.
...
Whole-upgrade readiness remains separately limited by missing Handler anchors; no Handler repair or installation is authorized.
